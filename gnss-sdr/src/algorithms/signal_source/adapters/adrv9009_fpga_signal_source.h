/*!
 * \file adrv9009_fpga_signal_source.h
...
#ifndef GNSS_SDR_ADRV9009_FPGA_SIGNAL_SOURCE_H
#define GNSS_SDR_ADRV9009_FPGA_SIGNAL_SOURCE_H
...
class Adrv9009FpgaSignalSource : public SignalSourceBase
{
public:
    Adrv9009FpgaSignalSource(const ConfigurationInterface *configuration,
        const std::string &role, unsigned int in_stream,
        unsigned int out_stream, Concurrent_Queue<pmt::pmt_t> *queue);

    ~Adrv9009FpgaSignalSource();
...
private:
    const std::string switch_device_name = std::string("axi_switch");          // Switch UIO device name
    ...
    const std::string default_profile_path = std::string("/home/ubuntu/Tx_BW200_IR245p76_Rx_BW50_OR61p44_ORx_BW200_OR245p76");
    ...
    uint64_t freq2_;  // frequency of local oscillator
...
/** \} */
/** \} */
#endif  // GNSS_SDR_ADRV9009_FPGA_SIGNAL_SOURCE_H
