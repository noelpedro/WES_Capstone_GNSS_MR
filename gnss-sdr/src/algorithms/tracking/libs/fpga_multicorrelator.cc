    ...
    if (d_secondary_code_enabled == true)
        {
    	    ...
    	    std::cout << "Drop samples enable secondary code " << enable_secondary_code << '\n';
        }
    else
        {
            d_map_base[drop_samples_reg_addr] = 0;  // block samples
            //std::cout << "Drop samples " << 0 << '\n';
        }
...
void Fpga_Multicorrelator_8sc::fpga_configure_tracking_gps_local_code(int32_t PRN)
{
    ...
    //std::cout << "COde length samples in HW " << d_code_length_samples << '\n';
}
...
void Fpga_Multicorrelator_8sc::fpga_configure_signal_parameters_in_fpga()
{
    ...
    d_map_base[nsamples_minus_1_reg_addr] = d_correlator_length_samples;  // number of samples
    //std::cout << "Correlator Length Samples " << d_correlator_length_samples << '\n';
...
void Fpga_Multicorrelator_8sc::set_secondary_code_lengths(uint32_t secondary_code_0_length, uint32_t secondary_code_1_length)
{
    ...
    //std::cout << "Secondary code length 0 " << secondary_code_0_length << '\n';
    //std::cout << "Secondary code length 1 " << secondary_code_1_length << '\n';
    ...
    //std::cout << "Secondary COdes Lengths " <<  secondary_code_length_1_minus_1 * 256 + secondary_code_length_0_minus_1 << '\n';
...
void Fpga_Multicorrelator_8sc::enable_secondary_codes()
{
    ...
    //std::cout << "Enable_secondary code " << drop_samples << '\n';
