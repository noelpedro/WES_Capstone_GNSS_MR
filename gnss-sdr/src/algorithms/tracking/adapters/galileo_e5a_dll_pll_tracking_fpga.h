...
private:
    const std::string default_device_name_Galileo_E5a = "multicorrelator_resampler_3_1";  // UIO device name
    //const std::string default_device_name_Galileo_E5a = "multicorrelator_resampler_S00_AXI";  // UIO device name
