...
private:
    const std::string device_name = "axi_sample_counter";  // UIO device name
    static const uint32_t page_size = 0x1000;             // default page size for the multicorrelator memory map
